...
app.get('/api/add/num1=:n1&num2=:n2', (req, res) => {
...
app.get('/api/sub/num1=:n1&num2=:n2', (req, res) => {
...
app.get('/api/mul/num1=:n1&num2=:n2', (req, res) => {
  const num1 = req.params.n1;
  const num2 = req.params.n2;
  const result = num1 * num2;
...
app.get('/api/div/num1=:n1&num2=:n2', (req, res) => {
  const num1 = req.params.n1;
  const num2 = req.params.n2;
  const result = num1 / num2;
